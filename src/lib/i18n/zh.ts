export const zh: Record<string, string> = {
  ...
  'exam.confidence': '信心',
  'exam.calibration': '校准',
  'exam.calibration.hitRate': '命中率',
  'exam.calibration.meanForecast': '平均信心',
  'exam.calibration.overconfident': '过度自信 {{delta}} 分 — 你的自信跑在准确率前面。',
  'exam.calibration.underconfident': '信心不足 {{delta}} 分 — 你掌握得比想的更多。',
  'exam.calibration.wellCalibrated': '校准良好 — 自信与准确率一致。',
  'exam.passed': '及格',
  'exam.failed': '尚未及格',
  ...
  'handoff.body': '复制紧凑的 SGH1.* 凭证,保存当前运行状态 — 之后可在本机或另一台设备继续,或交给同事接续。',
  'handoff.copyCurrent': '📋 复制当前运行凭证',
  'handoff.copied': '已复制。',
  'handoff.copyManual': '复制此交接凭证:',
  'handoff.none': '没有正在进行的运行可交接。',
  'handoff.resumeBtn': '⏵ 从凭证恢复',
  'handoff.resumed': '已恢复。',
  'handoff.invalid': '这看起来不是有效的交接凭证。',
  'handoff.unknownCase': '此凭证引用的病例不在你的目录中。',
  ...
  'sets.heading': '我的学习集',
  'sets.namePlaceholder': '新建集合名称',
  'sets.create': '+ 新建',
  'sets.empty': '从任意病例子集组成临时合集 — 本地保存。',
  'sets.delete': '删除集合',
  'sets.removeCase': '移除病例',
  'sets.addCase': '+ 添加病例',
  'sets.hidePicker': '取消',
  'sets.pickCase': '选择病例…',
  'sets.playFirst': '从第一例开始',
  'cheatsheet.open': '🖨 速查表(打印)',
  'competency.label': '能力层级',
  'competency.tier.novice': '新手',
  'competency.tier.advanced-beginner': '进阶新手',
  'competency.tier.competent': '胜任',
  'competency.tier.proficient': '熟练',
  'competency.tier.expert': '专家',
  'competency.reason.novice': '玩前几个病例打好基础 — 拓展病例,层级会上升。',
  'competency.reason.advancedBeginner': '你正在找规律。将平均分推过60%,并完成8个不同病例。',
  'competency.reason.competent': '稳固基础。把平均分推过75%、争取优异以晋升。',
  'competency.reason.proficient': '表现强劲。累积≥5例的优异成绩(≥90%)以晋升专家。',
  'competency.reason.expert': '专家级 — 在广泛病例上持续保持优异。',
  'competency.reason.calibrationBonus': '校准加分:你的自信与准确率一致 — 已晋升专家。',
  'goals.label': '本周目标',
  'goals.cases': '病例',
  'goals.distinctions': '优异',
  'goals.mean': '平均',
  'goals.edit': '编辑',
  'goals.close': '收起',
  'goals.allMet': '✅ 本周每项目标都达成,做得好。',
  'bookmark.save': '☆ 收藏',
  'bookmark.saved': '★ 已收藏',
  'bookmark.remove': '移除',
  'bookmark.heading': '待复习',
  'flashcards.open': '🃏 闪卡(复习)',
  'flashcards.heading': '决策闪卡',
  'flashcards.empty': '至少完成一个病例以构建卡组。',
  'flashcards.flipHint': '按空格/回车(或点击揭示)翻卡。',
  'flashcards.bestAnswer': '最佳答案',
  'flashcards.reveal': '揭示',
  'flashcards.prev': '← 上一张',
  'flashcards.next': '下一张 →',
  'flashcards.got': '✓ 答对',
  'flashcards.miss': '✗ 错过',
  'mastery.label': '掌握度分布',
  'mastery.consolidated': '已巩固',
  ...
  'freeze.label': '冻结',
  'calibration.trendLabel': '校准趋势(考试)',
  ...
  'walkthrough.scrub': '拖动时间线',
  'walkthrough.kbHint': '空格 播放/暂停 · ← → 拖动 1 秒 · Esc 关闭 · 点击任何人查看其角色卡',
  'walkthrough.canonicalCounter': '第 {{n}} 章 / 共 {{total}} 章(主线)',
  'duel.open': '⚔ 对战 — 传递设备',
  'duel.heading': '面对面对战',
  'duel.turn': '轮到',
  'duel.player1': '玩家1',
  ...
  'duel.draw': '🤝 平局',
  'challenge.open': '🎯 挑战好友',
  'challenge.heading': '挑战好友',
  'challenge.intro': '完成一份随机生成的试卷,然后分享代码。好友在自己的设备上完成同一份试卷,设法超越你的成绩 — 无需服务器,全程离线。',
  'challenge.create': '发起挑战',
  'challenge.accept': '接受代码',
  'challenge.yourName': '你的名字',
  'challenge.namePlaceholder': '例如:陈医生',
  'challenge.length': '试卷长度',
  'challenge.start': '开始',
  'challenge.pasteCode': '粘贴挑战代码',
  'challenge.codePlaceholder': 'SGP1-…',
  'challenge.invalidCode': '该代码无效。',
  'challenge.from': '来自 {{name}} 的挑战',
  'challenge.toBeat': '需超越的成绩',
  'challenge.challenger': '挑战者',
  'challenge.q': '第 {{n}} / {{total}} 题',
  'challenge.noFeedback': '答完前不提供反馈 — 与好友规则相同。',
  'challenge.yourCode': '你的挑战代码',
  'challenge.copy': '复制代码',
  'challenge.copied': '已复制!',
  'challenge.share': '把代码发给好友 — 他们做同一份试卷,设法超越你。',
  'challenge.youWin': '🏆 你赢了!',
  'challenge.youLose': '挑战者暂时领先',
  'challenge.draw': '🤝 平局',
  'challenge.you': '你',
  'challenge.replay': '新的挑战',
  ...
  'review.heading': '同行评议',
  'review.intro': '为每一步添加评论。保存仅在本浏览器;复制凭证发送给分享者。',
  'review.author': '你的姓名',
  'review.body': '评论',
  'review.bodyPlaceholder': '这一步做得好在哪里 — 你会怎么改?',
  'review.step': '第 {{n}} 步',
  'review.add': '添加评论',
  'review.copyToken': '📋 复制评议凭证',
  'review.copyManual': '复制此评议凭证并发送给该运行的作者:',
  'review.copied': '已复制。',
  'review.importSummary': '+ 导入评议凭证',
  'review.importBtn': '导入',
  'review.imported': '已合并到本线程。',
  'review.noneFound': '未找到匹配的评议凭证。',
