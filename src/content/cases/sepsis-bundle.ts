...
export const sepsisCase: CaseDefinition = {
  ...
  involvedFacilities: ['gp-healthway', 'scdf', 'ktph'],
  ...
  pathway: [
    ...
    },
    {
      ...
      decision: {
        ...
        reference: SSC,
        options: [
          { id: 'class-c', label: 'Class C.', score: 10, rationale: 'Best subsidy + MG top-up.', outcome: { patient: '', caregiver: 'Affordable.', staff: 'MSW pleased.' } },
          { id: 'class-b2', label: 'Class B2.', score: 6, rationale: 'Reasonable; smaller subsidy.', outcome: { patient: '', caregiver: '', staff: 'OK.' } },
          { id: 'class-a', label: 'Class A.', score: -3, rationale: 'No clinical benefit; financial harm.', outcome: { patient: '', caregiver: 'You apply for Medifund later.', staff: 'MSW counsels.' } },
        ],
      },
    },
    {
