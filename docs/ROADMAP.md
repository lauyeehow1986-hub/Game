...
| **v9.17** | **Three.js 3D cinematic renderer** — third option in the renderer toggle (2D / Cinematic / 3D). Full WebGL scenes with PBR-lit procedural environments, articulated 3D characters driven by the same `walkthrough-staging.ts` geometry, ACES tone mapping, soft shadows, beat-driven animation (walk / kneel / CPR compressions / collapse). | 🚧 in progress |
